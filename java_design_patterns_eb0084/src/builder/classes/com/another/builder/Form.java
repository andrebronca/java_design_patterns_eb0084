 ...
 * 12/set/2022
 *
 * @author andrebronca a maioria dos campos são opcionais
 * Essa forma permite que sejam criados objetos com configurações opcionais
 * distintas.
 */
public class Form {
  ...
  public static class FormBuilder {
    ...
    public FormBuilder address(String address){
      ...
      return this;  //permite o encadeamento dos métodos para a formação do objeto.
    }
